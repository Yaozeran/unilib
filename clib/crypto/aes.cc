 ...
 */
static void BytesSubstitution(aes_state* s, int inv) {
...
/** generate a bitmask where from-to bits are 1, others 0, from inclu, to exclu */
...
static void AESSetUp(aes_state* rounds, const uint8_t* key, int nkeywords, int nrounds) {
...
static void AESEncrypt(const aes_state* rounds, int nrounds, unsigned char* cipher16, const unsigned char* plain16) {
  aes_state s = {{0}};
  int round;
